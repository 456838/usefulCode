...
/**
 * Provides Base64New encoding and decoding in a streaming fashion (unlimited size). When encoding the default lineLength
...
public class Base64InputStream extends BaseNCodecInputStream {
    ...
    /**
     * Creates a Base64InputStream such that all data read is Base64New-decoded from the original provided InputStream.
     *
     * @param in
     *            InputStream to wrap.
     */
    ...
    /**
     * Creates a Base64InputStream such that all data read is either Base64New-encoded or Base64New-decoded from the original
    ...
    public Base64InputStream(final InputStream in, final boolean doEncode) {
        super(in, new Base64New(false), doEncode);
    }
    ...
    public Base64InputStream(final InputStream in, final boolean doEncode,
        ...
        super(in, new Base64New(lineLength, lineSeparator), doEncode);
    }
}
