...
public class Base64OutputStream extends BaseNCodecOutputStream {
    ...
    /**
     * Creates a Base64OutputStream such that all data written is Base64New-encoded to the original provided OutputStream.
     *
     * @param out
    ...
    /**
     * Creates a Base64OutputStream such that all data written is either Base64New-encoded or Base64New-decoded to the
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode) {
        super(out,new Base64New(false), doEncode);
    }
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode,
        ...
        super(out, new Base64New(lineLength, lineSeparator), doEncode);
    }
}
